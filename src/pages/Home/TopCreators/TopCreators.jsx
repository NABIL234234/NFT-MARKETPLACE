          ...
          <div>
            <div className="flex items-center pb-16">
              <div className="font-semibold text-white">
                <h2 className="text-5xl">Top creators</h2>
                <p className="text-xl pt-3">
                  Checkout Top Rated Creators on the NFT Marketplace
                </p>
              </div>
              <div className="flex w-52 items-center justify-center gap-3 rounded-xl text-white border-2 border-purple-500  p-4 mt-6 ml-auto">
                <img
                  src={Rocket}
                  alt="Rocket"
                />
