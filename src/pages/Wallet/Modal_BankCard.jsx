  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg w-80">
        <h3 className="text-2xl mb-4">Введите данные банковской карты</h3>
        <input
          type="text"
        ...
        <div className="flex justify-end">
          ...
          <button onClick={() => onSubmit({ cardNumber, cardExpiryDate, cvv })} className="bg-purple-600  hover:bg-white hover:text-black px-4 py-2 rounded">Отправить</button>
        </div>
      </div>
    </div>
  );
